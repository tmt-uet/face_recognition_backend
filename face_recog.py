...
class Face:
    ...
    def recognize(self, name, unknown_image_path):
        ...
        for i in range(len(known_path_image)):
            ...
            known_face_location = face_recognition.face_locations(known_image, number_of_times_to_upsample=2, model='cnn')
            unknown_face_location = face_recognition.face_locations(unknown_image, number_of_times_to_upsample=2, model='cnn')
